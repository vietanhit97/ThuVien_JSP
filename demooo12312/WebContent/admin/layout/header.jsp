		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="treeview"><a href="#"> <i class="fa fa-product-hunt"></i>
							<span><fmt:message bundle="${bun}" key="theadProduct" /> </span>
							<span class="pull-right-container"> <i
								class="fa fa-angle-left pull-right"></i>
						</span>
					</a>
						<ul class="treeview-menu">
							<li><a
								href="${pageContext.request.contextPath}/admin/product/index.jsp"><i
									class="fa fa-circle-o"></i> <fmt:message bundle="${bun }" key="theadDetailProduct" /></a></li>
						</ul></li>
				</ul>
			</section>
			<!-- /.sidebar -->

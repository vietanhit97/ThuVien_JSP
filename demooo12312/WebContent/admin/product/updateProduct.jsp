...
<section class="content">
	...
	<div class="box">
		<div class="box-header with-border">
			<h3 class="box-title"><fmt:message bundle="${bun}" key="theadUpdateProduct" /></h3>
